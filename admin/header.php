...
<nav class="navbar navbar-custom navbar-expand-lg navbar-dark">
  <a class="navbar-brand text-light" href="index.php"><h4>IIITK AEROPORTAL</h4></a>
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="nav-item">
              <div class="dropdown mt-2">
                <button class="btn bg-transparent dropdown-toggle text-white" type="button" 
                  ...
                  <i class="fa fa-plus text-white"></i> Airlines 
                </button>  
            ...
            <li class="nav-item p-1 border-light">
              <a class="nav-link" href="">
                ...
                <span class="nav_link text-light" style="font-size: 20px;">
