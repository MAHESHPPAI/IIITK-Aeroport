                  ...
                  if(!mysqli_stmt_prepare($stmt_f,$sql_f)) {
                      ...
                      if($row_f = mysqli_fetch_assoc($result_f)) {
                        ...
                        <div class="col-8 out">
                            <div class="row ">                                                     
                                <div class="col">
                                    <h2 class="mb-0 brand" style="color: black;">
                                        Your destination awaits—enjoy the ride!</h2> 
                                </div>
                                <div class="col">
